...
forbody:                                          ; preds = %forentry
  %i2 = load double, double* %i, align 8
  store double %i2, double* %j, align 8
  br label %forentry3
...
forentry3:                                        ; preds = %forbody8, %forbody
  %j4 = load double, double* %j, align 8
...
forbody8:                                         ; preds = %forentry3
  ...
  %j10 = load double, double* %j, align 8
  %nextvar = fadd double %j10, 1.000000e+00
  store double %nextvar, double* %j, align 8
  br label %forentry3
...
forcont9:                                         ; preds = %forentry3
  ...
  store double %nextvar13, double* %i, align 8
  br label %forentry
}
define double @__anon_expr() {
entry:
...
forentry:                                         ; preds = %forcont12, %entry
  %i2 = load double, double* %i, align 8
  %r3 = load double, double* %r1, align 8
...
forentry4:                                        ; preds = %if.cont, %forbody
  %j5 = load double, double* %j, align 8
  %r6 = load double, double* %r1, align 8
...
forbody11:                                        ; preds = %forentry4
  ...
  %r14 = load double, double* %r1, align 8
  %multmp15 = fmul double 2.000000e+00, %r14
  %subtmp = fsub double %i13, %multmp15
  %i16 = load double, double* %i, align 8
  %r17 = load double, double* %r1, align 8
  ...
  %r30 = load double, double* %r1, align 8
  %r31 = load double, double* %r1, align 8
...
forcont12:                                        ; preds = %forentry4
  ...
  %i38 = load double, double* %i, align 8
  %nextvar39 = fadd double %i38, 1.000000e+00
  store double %nextvar39, double* %i, align 8
  br label %forentry
...
if.cont:                                          ; preds = %if.else, %if.then
  ...
  %j36 = load double, double* %j, align 8
