...
entry:
  ...
  store double %v, double* %v1, align 8
  %v2 = load double, double* %v1, align 8
...
entry:
  ...
  store double %LHS, double* %LHS1, align 8
  store double %RHS, double* %RHS2, align 8
  %RHS3 = load double, double* %RHS2, align 8
  %LHS4 = load double, double* %LHS1, align 8
...
entry:
  ...
  store double %LHS, double* %LHS1, align 8
  store double %RHS, double* %RHS2, align 8
  %LHS3 = load double, double* %LHS1, align 8
...
if.else:                                          ; preds = %entry
  %RHS4 = load double, double* %RHS2, align 8
...
entry:
  ...
  %booltmp = uitofp i1 %lttmp to double
  %LHS5 = load double, double* %LHS1, align 8
  %RHS6 = load double, double* %RHS2, align 8
...
entry:
  ...
  %d2 = load double, double* %d1, align 8
...
if.else:                                          ; preds = %entry
  %d3 = load double, double* %d1, align 8
...
if.else9:                                         ; preds = %if.else
  %d10 = load double, double* %d1, align 8
...
entry:
  ...
  store double %real, double* %real1, align 8
  store double %imag, double* %imag2, align 8
  store double %iters, double* %iters3, align 8
  store double %creal, double* %creal4, align 8
  store double %cimag, double* %cimag5, align 8
  %iters6 = load double, double* %iters3, align 8
  %gttmp = fcmp ugt double %iters6, 2.550000e+02
  %booltmp = uitofp i1 %gttmp to double
  %real7 = load double, double* %real1, align 8
  %real8 = load double, double* %real1, align 8
  %multmp = fmul double %real7, %real8
  %imag9 = load double, double* %imag2, align 8
  %imag10 = load double, double* %imag2, align 8
...
if.then:                                          ; preds = %entry
  %iters14 = load double, double* %iters3, align 8
  br label %if.cont

if.else:                                          ; preds = %entry
  %real15 = load double, double* %real1, align 8
  %real16 = load double, double* %real1, align 8
  %multmp17 = fmul double %real15, %real16
  %imag18 = load double, double* %imag2, align 8
  %imag19 = load double, double* %imag2, align 8
  %multmp20 = fmul double %imag18, %imag19
  %subtmp = fsub double %multmp17, %multmp20
  %creal21 = load double, double* %creal4, align 8
  %addtmp22 = fadd double %subtmp, %creal21
  %real23 = load double, double* %real1, align 8
  %multmp24 = fmul double 2.000000e+00, %real23
  %imag25 = load double, double* %imag2, align 8
  %multmp26 = fmul double %multmp24, %imag25
  %cimag27 = load double, double* %cimag5, align 8
  %addtmp28 = fadd double %multmp26, %cimag27
  %iters29 = load double, double* %iters3, align 8
  %addtmp30 = fadd double %iters29, 1.000000e+00
  %creal31 = load double, double* %creal4, align 8
  %cimag32 = load double, double* %cimag5, align 8
...
entry:
  ...
  store double %real, double* %real1, align 8
  store double %imag, double* %imag2, align 8
  %real3 = load double, double* %real1, align 8
  %imag4 = load double, double* %imag2, align 8
  %real5 = load double, double* %real1, align 8
  %imag6 = load double, double* %imag2, align 8
...
entry:
  ...
  store double %xmin, double* %xmin1, align 8
  store double %xmax, double* %xmax2, align 8
  store double %xstep, double* %xstep3, align 8
  store double %ymin, double* %ymin4, align 8
  store double %ymax, double* %ymax5, align 8
  store double %ystep, double* %ystep6, align 8
  %ymin7 = load double, double* %ymin4, align 8
  store double %ymin7, double* %y, align 8
  br label %forentry

forentry:                                         ; preds = %forcont18, %entry
  %y8 = load double, double* %y, align 8
  %ymax9 = load double, double* %ymax5, align 8
...
forbody:                                          ; preds = %forentry
  %xmin10 = load double, double* %xmin1, align 8
  store double %xmin10, double* %x, align 8
  br label %forentry11
...
forentry11:                                       ; preds = %forbody17, %forbody
  %x12 = load double, double* %x, align 8
  %xmax13 = load double, double* %xmax2, align 8
...
forbody17:                                        ; preds = %forentry11
  %x19 = load double, double* %x, align 8
  %y20 = load double, double* %y, align 8
  %calltmp = call double @mandelconverge(double %x19, double %y20)
  %calltmp21 = call double @printdensity(double %calltmp)
  %xstep22 = load double, double* %xstep3, align 8
  %x23 = load double, double* %x, align 8
  %nextvar = fadd double %x23, %xstep22
  store double %nextvar, double* %x, align 8
  br label %forentry11
...
forcont18:                                        ; preds = %forentry11
  ...
  %ystep25 = load double, double* %ystep6, align 8
  %y26 = load double, double* %y, align 8
  %nextvar27 = fadd double %y26, %ystep25
  store double %nextvar27, double* %y, align 8
  br label %forentry
}
...
entry:
  ...
  store double %realstart, double* %realstart1, align 8
  store double %imagstart, double* %imagstart2, align 8
  store double %realmag, double* %realmag3, align 8
  store double %imagmag, double* %imagmag4, align 8
  %realstart5 = load double, double* %realstart1, align 8
  %realstart6 = load double, double* %realstart1, align 8
  %realmag7 = load double, double* %realmag3, align 8
  %multmp = fmul double %realmag7, 7.800000e+01
  %addtmp = fadd double %realstart6, %multmp
  %realmag8 = load double, double* %realmag3, align 8
  %imagstart9 = load double, double* %imagstart2, align 8
  %imagstart10 = load double, double* %imagstart2, align 8
  %imagmag11 = load double, double* %imagmag4, align 8
  %multmp12 = fmul double %imagmag11, 4.000000e+01
  %addtmp13 = fadd double %imagstart10, %multmp12
  %imagmag14 = load double, double* %imagmag4, align 8
